        ...
        <header>
         ...
         <div class="duration">
            <div class="durationtop">
              <div class="duration_number"><i>8</i>h<i>20</i>m</div>
            ...
            <div class="bottom">
              ...
              <div class="btom_textBox shenshuimian">
                <div class="btom_textBox_number"><i>1</i>h<i>14</i>m</div>
              ...
              <div class="btom_textBox qianshuimian">
                <div class="btom_textBox_number"><i>7</i>h<i>06</i>m</div>
              ...
              <div class="btom_textBox qinxing">
                <div class="btom_textBox_number"><i>0</i>h<i>20</i>m</div>
          ...
          <div class="shuomingBox">
            ...
            <p>
              首先，保持睡眠的环境安静，且不要有光线，最好选用遮光窗帘。其次，最好固定睡眠时间，每天在同一个时间上床，同一个时间起床，时间不要过长。
            </p>
          </div>
    </div>
</template>
...
.durationtop .duration_number, .btom_textBox_number {
  text-align: center;
  font-size: 0.24rem;
}
